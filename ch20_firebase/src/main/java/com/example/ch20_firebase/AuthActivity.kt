    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.googleLoginBtn.setOnClickListener {
            ...
            val gso = GoogleSignInOptions
                ...
                .requestIdToken("401160650123-auf0mqt4n04r79uk89k24dv7cu86j4b1.apps.googleusercontent.com")
                .requestEmail()
                .build()
            //구글의 인증관리 앱 실행
                ...
                .addOnCompleteListener(this){ task ->
                    ...
                    if (task.isSuccessful){
                        if (MyApplication.checkAuth()){
                            ...
                            //발송된 메일로 인증확인을 안한 경우
                            Toast.makeText(baseContext,"전송된 메일로 인증이 되지 않았습니다",Toast.LENGTH_SHORT).show()
                        }
                    } else {
